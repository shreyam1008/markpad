...
- Current frontend slices: native `<canvas>` infinite surface, bounded undo/redo, Markpad JSON autosave, Markpad/Obsidian-style JSON import, JSON export, and SVG export.
