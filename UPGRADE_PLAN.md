...
- Current frontend slices: native `<canvas>` infinite surface, bounded undo/redo, Markpad JSON autosave, Markpad/Obsidian-style JSON import, JSON export, SVG export, and save-to-draft for existing Save As persistence.
