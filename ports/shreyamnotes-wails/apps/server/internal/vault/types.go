...
type ListNotesPageFilter struct {
	Folder  NoteFolder   `json:"folder,omitempty"`
	Folders []NoteFolder `json:"folders,omitempty"`
}

type ListNotesPageRequest struct {
	RequestID string              `json:"requestId,omitempty"`
	Offset    int                 `json:"offset"`
	Limit     int                 `json:"limit,omitempty"`
	ChunkSize int                 `json:"chunkSize,omitempty"`
	Query     string              `json:"query,omitempty"`
	Filter    ListNotesPageFilter `json:"filter,omitempty"`
	Sort      string              `json:"sort,omitempty"`
}

type ListNotesPageResponse struct {
