...
const APP_WEBSITE_URL = 'https://github.com/shreyam1008/shreyamnotes'
const APP_DISCORD_URL = 'https://github.com/shreyam1008/shreyamnotes/discussions'
const APP_REPOSITORY_URL = 'https://github.com/shreyam1008/shreyamnotes'
const APP_RELEASES_URL = 'https://github.com/shreyam1008/shreyamnotes/releases/latest'
const APP_ISSUES_URL = 'https://github.com/shreyam1008/shreyamnotes/issues'
      ...
      run: async () => {
        ...
        if (!status.available) {
          await confirmApp({
            ...
            description:
              status.reason ?? 'The CLI wrapper has not been built yet. Run `bun run build` or open Settings → CLI for details.',
            confirmLabel: 'OK',
            cancelLabel: 'Close'
          })
          return
        ...
        if (status.installedAt && !status.installedByThisApp) {
          await confirmApp({
            ...
            description: `${status.installedAt} is not managed by ShreyamNotes. Remove it manually if you want ShreyamNotes to take over.`,
            confirmLabel: 'OK',
            cancelLabel: 'Close'
          })
          return
