...
export function VimNav(): JSX.Element | null {
  ...
  const ctrlWTimer = useRef<ReturnType<typeof setTimeout> | undefined>(undefined)
  const jumpTopTimer = useRef<ReturnType<typeof setTimeout> | undefined>(undefined)
  const previousBufferTimer = useRef<ReturnType<typeof setTimeout> | undefined>(undefined)
  const nextBufferTimer = useRef<ReturnType<typeof setTimeout> | undefined>(undefined)
