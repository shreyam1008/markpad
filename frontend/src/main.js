...
function runClosestAction(event, selector, action) {
  if (event.target.closest(selector)) return action();
}
...
modalBodyEl.addEventListener('click', async (e) => {
  ...
  await runClosestAction(e, '[data-export-local-settings]', exportLocalSettings);
  await runClosestAction(e, '[data-copy-local-settings]', copyLocalSettings);
  runClosestAction(e, '[data-import-local-settings]', importLocalSettings);
  await runClosestAction(e, '[data-copy-loaded-workspace-md]', copyLoadedWorkspaceMarkdown);
  runClosestAction(e, '[data-export-loaded-workspace-md]', exportLoadedWorkspaceMarkdown);
  await runClosestAction(e, '[data-copy-loaded-workspace-json]', copyLoadedWorkspaceJson);
  runClosestAction(e, '[data-export-loaded-workspace-json]', exportLoadedWorkspaceJson);
  await runClosestAction(e, '[data-copy-loaded-workspace-csv]', copyLoadedWorkspaceCsv);
  runClosestAction(e, '[data-export-loaded-workspace-csv]', exportLoadedWorkspaceCsv);
  await runClosestAction(e, '[data-copy-footprint-md]', copyLocalFootprintMarkdown);
  await runClosestAction(e, '[data-export-footprint-md]', exportLocalFootprintMarkdown);
  await runClosestAction(e, '[data-copy-footprint-json]', copyLocalFootprintJson);
  await runClosestAction(e, '[data-export-footprint-json]', exportLocalFootprintJson);
  await runClosestAction(e, '[data-copy-footprint-csv]', copyLocalFootprintCsv);
  await runClosestAction(e, '[data-export-footprint-csv]', exportLocalFootprintCsv);
  await runClosestAction(e, '[data-copy-runtime-text]', copyRuntimeStats);
  await runClosestAction(e, '[data-export-runtime-text]', exportRuntimeStatsText);
  await runClosestAction(e, '[data-copy-runtime-md]', copyRuntimeStatsMarkdown);
  await runClosestAction(e, '[data-export-runtime-md]', exportRuntimeStatsMarkdown);
  await runClosestAction(e, '[data-copy-runtime-json]', copyRuntimeStatsJson);
  await runClosestAction(e, '[data-export-runtime-json]', exportRuntimeStatsJson);
  await runClosestAction(e, '[data-copy-runtime-csv]', copyRuntimeStatsCsv);
  await runClosestAction(e, '[data-export-runtime-csv]', exportRuntimeStatsCsv);
  await runClosestAction(e, '[data-copy-asset-report-md]', copyLightweightAssetReportMarkdown);
  runClosestAction(e, '[data-export-asset-report-md]', exportLightweightAssetReportMarkdown);
  await runClosestAction(e, '[data-copy-asset-report-json]', copyLightweightAssetReportJson);
  runClosestAction(e, '[data-export-asset-report-json]', exportLightweightAssetReportJson);
  await runClosestAction(e, '[data-copy-canvas-summary-md]', copyCanvasMarkdownSummary);
  runClosestAction(e, '[data-export-canvas-summary-md]', exportCanvasMarkdownSummary);
