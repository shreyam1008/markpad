...
function showHelpModal() {
  showModal('Help', `
    ...
    <p><b>Canvas</b> uses lightweight local JSON. Select moves elements, color/width edit selected shapes, grid/snap/minimap help alignment, and Write updates the active .canvas/JSON/draft document. Import/export supports Markpad JSON, Obsidian/JSON Canvas, Excalidraw scenes, SVG, PNG viewport, and Markdown summaries.</p>
...
async function showPreferences() {
  ...
  showModal('Preferences', `
    ...
    <table style="width:100%;border-collapse:collapse;font-size:12px;line-height:1.6;">
      ...
      <tr style="border-bottom:1px solid #e8e6df;"><td style="padding:4px 6px;font-weight:600;">Canvas</td><td style="padding:4px 6px;">Local JSON canvas view, Obsidian/JSON Canvas import/export, Excalidraw import/export, SVG, PNG viewport, Markdown summary, Write to active .canvas/JSON/draft</td></tr>
