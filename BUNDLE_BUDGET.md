...
|---|---:|---:|
| Stripped Linux binary | 13,636,424 bytes (13.00 MiB) | hard ceiling 16 MiB |
| Stripped Windows binary | 16,799,232 bytes (16.02 MiB) | hard ceiling 16.1 MiB |
| Frontend JavaScript | 4,602,483 bytes (4.39 MiB) raw, one WebKit-safe entry bundle | avoid unbounded growth |
| Frontend CSS | 127,754 bytes (124.8 KiB) raw | generated by Tailwind |

Sizes were measured from the v0.13.2 release candidate on 2026-09-03. The redesigned workbench, responsive source viewers, incremental CodeMirror editor, modern Markdown/Mermaid support, bounded relative-image loading, Linux WebKitGTK-safe production bundle, unified assets, and strengthened interaction contracts remain inside their release ceilings.
