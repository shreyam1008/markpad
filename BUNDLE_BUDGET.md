...
| Stripped Windows binary | 16,209,920 bytes (15.46 MiB) | hard ceiling 16 MiB |
| Frontend JavaScript | 3,995,302 bytes (3.81 MiB) raw, code-split | avoid unbounded growth |
| Frontend CSS | 125,159 bytes (122.2 KiB) raw | generated by Tailwind |

Sizes were measured from the v0.12.0 release candidate on 2026-09-02. The redesigned workbench, responsive source viewers, modern Markdown/Mermaid support, unified assets, and strengthened interaction contracts remain inside the 16 MiB binary ceiling.
