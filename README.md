...
and bounded rendering. **Planned, not available in 0.14.4.**
...
|---------|------|------------|
| 0.14.4 | Safer reloads & updates | External-file change banner, draft-preserving disk reloads, History labels, and verified Windows/Linux update handoff; GitHub-only patch |
