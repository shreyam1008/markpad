...
version = re.search(r'^const Version = "([0-9.]+)"', (root / 'main.go').read_text(encoding="utf-8"), re.M)[1]
...
assert f'VERSION = "{version}"' in (root / 'frontend/src/brand.ts').read_text(encoding="utf-8")
