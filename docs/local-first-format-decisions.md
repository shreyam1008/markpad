...
- Empty states: offer text-only actions to add a task, create/open the task file workflow, inspect source profile, and reset filters without adding another task store.
