...
- Keep search empty-state recovery actions text/CSS-only and wired to existing local scopes, parsed query chips, query inspector, profile, current-file search, and cache cleanup paths.
