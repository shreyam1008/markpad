...
- Canvas create: the sidebar `+ New` Canvas action should start a scratch canvas immediately; explicit `.markcanvas.json` creation lives in the Canvas workflow menu.
