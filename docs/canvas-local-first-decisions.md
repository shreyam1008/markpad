...
- Hint/status text: derive from existing in-memory canvas state so empty, drawing, panning, and selected states teach the surface without extra persisted data.
